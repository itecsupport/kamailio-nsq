...
static void
nsqd_connection_connect_cb(struct BufferedSocket *buffsock, void *arg)
{
...
static void
nsqd_connection_read_size(struct BufferedSocket *buffsock, void *arg)
{
    struct NSQDConnection *conn = (struct NSQDConnection *)arg;
...
static void
nsqd_connection_read_data(struct BufferedSocket *buffsock, void *arg)
{
    struct NSQDConnection *conn = (struct NSQDConnection *)arg;
...
static void
nsqd_connection_close_cb(struct BufferedSocket *buffsock, void *arg)
{
    struct NSQDConnection *conn = (struct NSQDConnection *)arg;
...
static void
nsqd_connection_error_cb(struct BufferedSocket *buffsock, void *arg)
{
    struct NSQDConnection *conn = (struct NSQDConnection *)arg;
...
void
free_nsqd_connection(struct NSQDConnection *conn)
{
    if (conn) {
...
int
nsqd_connection_connect(struct NSQDConnection *conn)
{
    return buffered_socket_connect(conn->bs);
}

void
nsqd_connection_disconnect(struct NSQDConnection *conn)
{
